...
const couchColor = "#e5a7fb";
const wallColor = "#bbb";
const cactusColor = "#05A325";
const tableTopColor = "#0f2a7b";
const tableColor = "#0f2a7b";
const donutColor = "#62badf";
const torusKnotColor = "#2321a1";
const recordPlayerColor = "#7c4d1b";
const streamerColor = "#04063e";
const treeColor = "#0f6120";
const cactusPotColor = "#8e80ff";
const rugColor = "#9bb0ee";
