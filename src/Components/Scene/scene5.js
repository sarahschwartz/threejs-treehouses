...
const couchColor = "#ffd84d";
const wallColor = "#bbb";
const cactusColor = "#05A325";
const tableTopColor = "#ffb8b8";
const tableColor = "#ffed7a";
const donutColor = "#cb72ae";
const torusKnotColor = "#8fffec";
const recordPlayerColor = "#7c4d1b";
const streamerColor = "#7752ff";
const treeColor = "#7dcf8e";
const cactusPotColor = "#e59eff";
const rugColor = "#f8c8ea";
