...
const couchColor = "#167e2b";
const wallColor = "#bbb";
const cactusColor = "#247f36";
const tableTopColor = "#92511c";
const donutColor = "#cb72ae";
const torusKnotColor = "#696969";
const recordPlayerColor = "#7c4d1b";
const streamerColor = "#c3d822";
const treeColor = "#0f6120";
const rugColor = "#fff";
const cactusPotColor = "#98720b";
...
const treehouseScene = [
  ...
  },
  {
    ...
    meshes: [
      ...
      },
      {
        ...
        name: "Roof Wall 3",
        scale: [1, 1, 1],
        position: [-2.16, 5.231, -1.921],
        rotation: [0, 0, 0],
        yRotationSpeed: 0,
        geometry: {
          type: "BoxGeometry",
          args: [1.4375, 0.96, 0.16]
        },
        material: {
          type: "meshStandardMaterial",
          color: wallColor,
  ...
  {
    type: "mesh",
    name: "Coffee Table Leg 1",
    scale: [1, 1, 1],
    position: [-0.9, 0.7, 1.389],
    rotation: [0, 0, 0],
    yRotationSpeed: 0,
    geometry: {
      type: "BoxGeometry",
  ...
  {
    type: "mesh",
    name: "Coffee Table Leg 2",
    scale: [1, 1, 1],
    position: [0.289, 0.7, 1.389],
    rotation: [0, 0, 0],
    yRotationSpeed: 0,
    geometry: {
      type: "BoxGeometry",
  ...
  {
    type: "mesh",
    name: "Coffee Table Leg 3",
    scale: [1, 1, 1],
    position: [-0.9, 0.7, -0.435],
    rotation: [0, 0, 0],
    yRotationSpeed: 0,
    geometry: {
      type: "BoxGeometry",
  ...
  {
    type: "mesh",
    name: "Coffee Table Leg 4",
    scale: [1, 1, 1],
    position: [0.289, 0.7, -0.435],
    rotation: [0, 0, 0],
    yRotationSpeed: 0,
    geometry: {
      type: "BoxGeometry",
  ...
  },
  {
    ...
    name: "Donut Plate",
    scale: [1, 1, 1],
    position: [-0.287, 1.09, 0.49],
    rotation: [0, 0, 0],
    yRotationSpeed: 0,
    geometry: {
      type: "CylinderGeometry",
      args: [0.2, 0.2, 0.05, 15, 20]
    },
    material: {
      type: "meshStandardMaterial",
      color: torusKnotColor
